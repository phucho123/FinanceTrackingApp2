            ...
            <View style={styles.container}>
                ...
                <View style={styles.block3}>
                    <ChangeTypeButton
                        ...
                        type2={
                            ...
                            >
                                <Text style={typeFinance == "income" ? { color: "white" } : { color: "black" }}>
                                    Income
                                </Text>
                            </TouchableOpacity>
                        }
                ...
                <View style={styles.block4}>
                    <View>
                        <Select
                            data={data3}
                            style={{ width: 130 }}
                            onChangeF={(item) => setTransactionOrCategory(item.value)}
                        />
                    </View>
                </View>
                ...
                <View style={styles.block5}>
                    {transactionOrCategory == "category" && (
                        <CategoryCard percent={30} title={"Food"} prices={"-$120"} type={"expense"} />
                    )}
                    {transactionOrCategory == "transaction" && (
                        <TransactionCard title={"Food"} prices={"-$120"} time={"10:00 AM"} type={"expense"} />
                    )}
                </View>
            </View>
        </ScrollView>
